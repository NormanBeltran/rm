...
from acerca_de_mi import acerca_de_mi
from descripcion_proyecto import descripcion_proyecto

st.title("Recetas del mundo")

# Sidebar
st.sidebar.title("Navegación")
opcion = st.sidebar.radio("Selecciona una opción", ["Recetas", "Acerca de mí", "Descripción del proyecto"])
...
elif opcion == "Acerca de mí":
    acerca_de_mi()

elif opcion == "Descripción del proyecto":
